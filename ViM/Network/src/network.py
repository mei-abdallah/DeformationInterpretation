...
class Network(nn.Module):
    def __init__(self,
                 backbone:Literal['vim_small_patch16_stride16_224', 'vit_small_patch16_stride8_224', 'vim_tiny_patch16_stride16_224', 'vit_tiny_patch16_stride8_224'], 
        ...
        self.model = ViM(backbone, num_classes, num_locations, color, freeze, pretrained)
